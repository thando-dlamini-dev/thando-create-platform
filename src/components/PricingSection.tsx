            ...
            <div className="font-geist-mono w-screen min-h-120 flex flex-col justify-between items-center">
                <div className="rounded-2xl w-6xl h-4/5 flex flex-col justify-between items-center pt-20">
                    ...
                    <div className="w-full h-full flex items-start justify-between p-5 gap-5">
                        <div
                            className="w-1/3 min-h-100 bg-neutral-200 shadow-md border-1 border-neutral-300 rounded-2xl p-1 mt-20 flex-col items-start justify-start p-5">
                        ...
                        <div
                            className="w-1/3 min-h-100 bg-neutral-200 shadow-md border-1 border-green-600 rounded-2xl p-1 mt-20 flex-col items-start justify-start p-5 relative">
