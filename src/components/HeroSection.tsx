                    ...
                    <div className='w-full h-full rounded-2xl flex flex-col justify-start gap-2 items-start'>
                        ...
                        <div className='w-1/2 min-h-30 flex items-center justify-start'>
                            <motion.p initial={{opacity: 0, y: -15}} animate={{opacity: 1, y: 0}}
                                      ...
                                      className='mb-3 text-neutral-800 font-geist-mono-regular'>We combine AI-powered planning with expert
                        ...
                        <motion.div initial={{opacity: 0, y: -20}} animate={{opacity: 1, y: 0}}
                            ...
                            <Link
                                className='text-text-col text-neutral-900 bg-neutral-300 border-accent hover:text-black py-2 px-5 rounded-sm font-light hover:scale-105 transition-all duration-300 hover:bg-accent' to='/login'>
                                Login
                            </Link>
                            <Link className='text-md text-text-col border-1 border-neutral-400 hover:text-accent py-2 px-6 rounded-sm font-light hover:scale-105 transition-all duration-300 flex justify-evenly items-center gap-3' to='/services'>
                                Explore Services
                            </Link>
                        </motion.div>
                    </div>
