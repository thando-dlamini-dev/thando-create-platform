                    ...
                    <div className='min-w-full h-2/3 flex items-center justify-evenly py-2'>
                        {principlesData.map((principle) => (
                            <motion.div initial={{opacity: 0, y: -50}} whileInView={{opacity: 1, y: 0}} transition={{
                                ...
                                <h1 className={`${clicked === principle.title ? 'text-xl text-accent' : 'text-lg text-neutral-800'} ease-in-out transition-all duration-300 absolute bottom-5 left-6 text-2xl font-geist-mono-regular`}>{principle.title}</h1>
